...
func TestDecodeBody(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, got, err := decodeBody(tc.body, h, schemaRef, encFn, &fastjson.Parser{})
...
func TestRegisterAndUnregisterBodyDecoder(t *testing.T) {
	...
	decoder = func(body io.Reader, h http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (decoded any, err error) {
		var data []byte
	...
	_, got, err := decodeBody(body, h, schema, encFn, &fastjson.Parser{})
	...
	_, _, err = decodeBody(body, h, schema, encFn, &fastjson.Parser{})
