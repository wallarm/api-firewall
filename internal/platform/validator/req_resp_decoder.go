...
func decodeContentParameter(param *openapi3.Parameter, input *openapi3filter.RequestValidationInput) (
	value any, schema *openapi3.Schema, found bool, err error) {
...
func defaultContentParameterDecoder(param *openapi3.Parameter, values []string) (
	outValue any, outSchema *openapi3.Schema, err error) {
...
func decodeStyledParameter(param *openapi3.Parameter, input *openapi3filter.RequestValidationInput) (any, bool, error) {
	...
	case openapi3.ParameterInQuery:
		queryParams := input.GetQueryParams()
		if len(queryParams) == 0 {
			return nil, false, nil
		}
		dec = &urlValuesDecoder{values: queryParams}
	case openapi3.ParameterInHeader:
...
type BodyDecoder func(io.Reader, http.Header, *openapi3.SchemaRef, EncodingFn, *fastjson.Parser) (any, error)
...
func plainBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
...
func multipartPartBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	data, err := io.ReadAll(body)
	if err != nil {
		return nil, &ParseError{Kind: KindInvalidFormat, Cause: err}
	}

	dataStr := utils.B2S(data)
...
func jsonBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	var data []byte
	var err error
...
func xmlBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	var data []byte
	var err error
...
func yamlBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	var value any
...
func urlencodedBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
...
func multipartBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	if !schema.Value.Type.Is("object") {
		return nil, errors.New("unsupported schema of request body")
	}
...
func FileBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
	data, err := io.ReadAll(body)
	if err != nil {
		return nil, err
	}
...
func zipFileBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
...
func csvBodyDecoder(body io.Reader, header http.Header, schema *openapi3.SchemaRef, encFn EncodingFn, jsonParser *fastjson.Parser) (any, error) {
