...
stop_k6_tests:
	@docker-compose -f demo/docker-compose/docker-compose-api-mode.yml down

run_k6_tests: stop_k6_tests
	@docker-compose -f demo/docker-compose/docker-compose-api-mode.yml up --build --detach --force-recreate
